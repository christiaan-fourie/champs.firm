...
export default function About() {
  return (
      <div className="flex p-12 md:p-16">   
        <div className="
              bg-[url('/assets/backgrounds/africa.png')] 
              bg-contain bg-repeat-none bg-no-repeat
              hidden md:block 
              h-[70vh] w-1/2
              fixed -z-30 
              left-12
        ...
        <div>
              <div className="text-center md:text-right lg:w-1/2 ml-auto mt-8">
                <div className=" text-white text-6xl md:text-right font-extrabold text-center">
                ...
                <div className="w-1/2 h-[2px] bg-gradient-to-l from-[#84be1f] to-[#1b6ec5] from-30% to-70% my-10 py-2/1 mx-auto md:mr-0"></div>
